...
public class CareTipController {
    ...
    public List<CareTip> getAllCareTips() {
        return careTipService.getAllCareTips();
    }

    @GetMapping("/{id}")
    public Optional<CareTip> getCareTipById(@PathVariable String id) {
        return careTipService.getCareTipById(id);
    }

    @PostMapping
    public CareTip createCareTip(@RequestBody CareTip careTip) {
        return careTipService.createCareTip(careTip);
    }

    @PutMapping("/{id}")
    public CareTip updateCareTip(@PathVariable String id, @RequestBody CareTip updatedCareTip) {
        return careTipService.updateCareTip(id, updatedCareTip);
    }

    @DeleteMapping("/{id}")
    public void deleteCareTip(@PathVariable String id) {
